  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.scrollView}>
        ...
        >
          <View lightColor="#f5f5f5" style={{ marginVertical: 3 }}>
            <Text style={{ fontSize: 12 }}>
              "ビッグデータ を活用する確率モデリング技術" : 本村陽一
            </Text>
          </View>
          <View lightColor="#f5f5f5" style={{ marginVertical: 3 }}>
            <Text style={{ fontSize: 12 }}>
              "パナソニックの「脱プロダクトアウト」に向けた共創型プロジェクト" :
              宮下雄治, 端義幸
            </Text>
          </View>
          <View lightColor="#f5f5f5" style={{ marginVertical: 3 }}>
            <Text style={{ fontSize: 12 }}>
              "教育ビッグデータの利活用に向けた学習ログの蓄積と分析" : 緒方広明
            </Text>
          </View>
          <View lightColor="#f5f5f5" style={{ marginVertical: 3 }}>
            <Text style={{ fontSize: 12 }}>
              "医療ビッグデータの医療政策への活用" : 松田晋哉
            </Text>
          </View>
          <View lightColor="#f5f5f5" style={{ marginVertical: 3 }}>
            <Text style={{ fontSize: 12 }}>
